...
void Engine::Init()
{
	...
	primitiveManager->Create(Primitive::Type::BOX, Vector3(1, 1, 1), Vector3(-5, 15, 10), Vector3(10, 0, 0));
	//primitiveManager->Create(Primitive::Type::BOX, Vector3(1, 1, 1), Vector3(5, 10, 10), Vector3(0, 0, 0));
	//primitiveManager->Create(Primitive::Type::BOX, Vector3(3, 1, 3), Vector3(1, 5, 0), Vector3(0, 0, 0));
	//primitiveManager->CreateSphere(2, Vector3(-3, 15, 10));
