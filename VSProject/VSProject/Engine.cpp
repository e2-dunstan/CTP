...
void Engine::Init()
{
	...
	primitiveManager->Create(Primitive::Type::BOX, Vector3(1, 1, 1), Vector3(0, 10, 8), Vector3(0, 0, 0));
	...
	primitiveManager->CreateSphere(2, Vector3(0, 15, 8));
	...
	primitiveManager->CreateSphere(2, Vector3(10, 150, 0.1));
