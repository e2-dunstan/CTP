...
void Engine::Init()
{
	...
	primitiveManager->Create(Primitive::Type::BOX, Vector3(1.2, 1.2, 1.2), Vector3(0, 10, 10), Vector3(0, 90, 0));
	primitiveManager->Create(Primitive::Type::BOX, Vector3(1, 1, 1), Vector3(0.5, 20, 10), Vector3(45, 0, 45));
