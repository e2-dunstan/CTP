...
void Engine::Init()
{
	...
	primitiveManager->Create(Primitive::Type::PLANE, Vector3(64, 64, 64), Vector3(0,7,0), Vector3());
	//primitiveManager->Create(Primitive::Type::BOX, Vector3(1, 1, 1), Vector3(-4, 10, 7), Vector3(0, 0, 0));
	//primitiveManager->Create(Primitive::Type::BOX, Vector3(1, 2, 1), Vector3(-4, 10, 10), Vector3(0, 0, 0));
	//primitiveManager->Create(Primitive::Type::BOX, Vector3(3, 1, 3), Vector3(1, 5, 0), Vector3(0, 0, 0));
	primitiveManager->CreateSphere(1, Vector3(0, 10, 7));
