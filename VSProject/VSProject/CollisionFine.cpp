...
bool CollisionFine::BoxesOverlapOnAxis(const Primitive* box1, const Primitive* box2, const Vector3& toCentre, const Vector3& axis)
{
...
void CollisionFine::BoxAndBox(const Primitive* box1, const Primitive* box2)
{
